...
require (
	github.com/Layr-Labs/eigensdk-go v0.2.0-beta.1.0.20250121160212-04449ff5cb25
...
replace github.com/ethereum/go-ethereum v1.14.0 => github.com/ethereum-optimism/op-geth v1.101411.2-rc.2
